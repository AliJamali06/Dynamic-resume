...
//   const contact = (document.getElementById('contact') as HTMLInputElement).value;
//   const mobile = (document.getElementById('mobile') as HTMLInputElement).value;
//   const address = (document.getElementById('address') as HTMLInputElement).value; // Fixed typo
//   const education = (document.getElementById('education') as HTMLInputElement).value;
//   const skills = (document.getElementById('skills') as HTMLInputElement).value;
//   const experience = (document.getElementById('experience') as HTMLInputElement).value;
//   const photoInput = document.getElementById('photo') as HTMLInputElement; // Fixed typo
//   const profileImage = document.getElementById('profileImage') as HTMLImageElement; // Fixed type
...
// const editResumeButton = document.getElementById('edit-resume') as HTMLButtonElement; // Fixed typo
// editResumeButton.addEventListener('click', function () {
//   // Hide the resume output and buttons
//   (document.getElementById('resumeOutput') as HTMLElement).style.display = 'none';
//   (document.getElementById('download-pdf') as HTMLElement).style.display = 'none';
//   (document.getElementById('edit-resume') as HTMLElement).style.display = 'none';

//   // Show the form again to allow editing
//   resumeForm.style.display = 'block';
// });
